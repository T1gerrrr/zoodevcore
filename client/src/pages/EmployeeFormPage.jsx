  ...
  return (
    <div className="page">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card mb-lg">
          <div className="card-header">
            <h3>Cấu hình Tính lương</h3>
          </div>
          <div className="card-body">
            <div className="form-group mb-md">
              <label className="form-label">Hình thức trả lương</label>
            ...
            <div className="form-row">
              {form.salaryType === 'hourly' ? (
                <div className="form-group">
                  <label className="form-label">Đơn giá lương theo giờ (VNĐ / giờ)</label>
                  <input
                    type="number"
                    className="form-input"
                ...
                <div className="form-group">
                  <label className="form-label">Đơn giá lương theo ngày (VNĐ / ngày)</label>
                  <input
                    type="number"
                    className="form-input"
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  type="time"
                  className="form-input"
                  value={form.schedule.shiftStart}
                  onChange={(e) => handleScheduleChange('shiftStart', e.target.value)}
                />
              </div>
              <div className="form-group">
                ...
                <input
                  type="time"
                  className="form-input"
                  value={form.schedule.shiftEnd}
                  onChange={(e) => handleScheduleChange('shiftEnd', e.target.value)}
                />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group">
                <label className="form-label">Số ngày làm / tuần</label>
                <input
                  type="number"
                  className="form-input"
                  value={form.schedule.workDaysPerWeek}
                  onChange={(e) => handleScheduleChange('workDaysPerWeek', e.target.value)}
                  min={1}
                  max={7}
                />
              </div>
              <div className="form-group">
                <label className="form-label">Số ngày làm / tháng</label>
                <input
                  type="number"
                  className="form-input"
                  value={form.schedule.workDaysPerMonth}
                  onChange={(e) => handleScheduleChange('workDaysPerMonth', e.target.value)}
                  min={1}
                  max={31}
                />
              </div>
